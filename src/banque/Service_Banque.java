...
public class Service_Banque {
    public static Banque banque=new Banque("Lassito","lassservices@gmail.com");
        ...
        for (int i=0;i<banque.nbrCompte;i++) {
            if (banque.getCompte()[i].getIdCompte()==c.getIdCompte()) {
                if (mt > 0) {
                    ...
                    System.out.println("Versé avec succès");
                    return true;
                }
            }
        }
        ...
        for (int i=0;i<banque.nbrCompte;i++) {
            if (banque.getCompte()[i].getIdCompte()==c.getIdCompte()) {
                if (c.getSolde() - mt >= 0) {
                    ...
                    System.out.println("Retiré avec succès");
                    return true;
                }
            }
        }
    ...
    public static boolean creeEtAjouterClient(Scanner clavier) {
        System.out.println("\n=============================================");
        System.out.println("Cree Et Ajouter Client a la Banque");
        System.out.println("ID     : ");
        int id =clavier.nextInt();
    ...
    public static void consulterDetailCliente(Scanner clavier) {
        System.out.println("\n=============================================");
        System.out.println("Consulter Detail Client");
        // get id 
        System.out.println("ID: ");
        int id =clavier.nextInt();
        // get compte
        ...
        if(position!=10)
        {
            for (int i=position;i<banque.nbrCompte;i++) {
                if(i+1<banque.nbrCompte) {
                    ...
                    banque.getCompte()[i].setD_creation(banque.getCompte()[i + 1].getD_creation());
    ...
    public static void afficherMenuServiceBanque() {
        ...
        System.out.println("|-> Service Infos ::");
